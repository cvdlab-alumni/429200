function creaVideo(){
	...
	var $video = $('#video');
	   ...
	   function createVideo (geom) {
		...
		pianoVideo.rotation.x = Math.PI/2;
		//pianoVideo.rotation.y = Math.PI;
		//pianoVideo.rotation.z = Math.PI/2;
        pianoVideo.position.set(52.25,13.95,6);
        //scene.add(videoTV);
		...
		pianoVideo.interact = function(){
			if(video.currentTime == time){
				...
				video.pause();
				pianoVideo.material.materials[4].map = THREE.ImageUtils.loadTexture("assets/textures/Nero.jpg");
				}
		};
