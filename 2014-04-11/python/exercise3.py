...
#ovest = PROD([ OFFSET([0.5,0.25])(TEXT("W")) , Q(1) ])
#tensor = MAT ([[0.75 ,0 ,0 ,0] ,[0 ,0.75 ,0.25 ,0] ,[0 ,0 ,0.75 ,0] ,[0 ,0 ,0 ,0.75]])
#OvestTensorato = tensor(ovest)
#OvestRotato = (ROTATE([1,2])(PI/2))(OvestTensorato)
#OvestTraslato = T([1,2,3,])([58,-10,0])(OvestRotato)
...
ParetiSuLivelli = STRUCT([Pareti,Livelli,Coni,Cipolle,CipolleMini,Creste,Colonnine,Giardino])
