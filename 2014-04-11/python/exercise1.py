...
Pareti = STRUCT([COLOR([0.80,0.4,0.11])(MuroNordConArchi),COLOR([0.80,0.4,0.11])(MuroSudConArchi),
	...
	COLOR([0.54,0.137,0.137])(T([1,2,3])([-12,0,0])(BalconcinoTraslato))])

Coni = STRUCT([cono1,cono2,cono3,cono4,cono5,cono6,cono7])

ParetiSuLivelli = STRUCT([Pareti,Livelli,cipollina1,cipollina2,cipollina3,cipollina4,cipollina5,cipollina6,cipolla1,Coni])
